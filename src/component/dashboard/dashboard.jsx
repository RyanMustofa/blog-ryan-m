...
class Dashboard extends React.Component {
    ...
    componentDidMount() {
        axios
            .get("http://127.0.0.1:8000/api/get-article")
            .then(res => {
                console.log(res);
            })
            .catch(err => {
                ...
                <div className="container" style={{ marginTop: "200px" }}>
                    ...
                    <div className="row mt-2">
                        <div className="col-md-6 col-sm-12 mt-5 text-center mb-4 wow fadeInLeft">
                            ...
                            <Link className="btn btn-outline-primary mt-4 tombol" to="/article">
                                Go
                            </Link>
                        </div>
                    ...
                    <div className="row mt-5 pt-4">
                        <div className="col-md-6 col-sm-12 wow fadeInLeft">
                            <img className="img-fluid" src={g2} style={{ borderRadius: "20px" }} width="400" height="350" alt="" />
                        </div>
                        <div className="col-md-6 col-sm-12 text-center wow fadeInRight">
                            <h4>and articles about school lessons<br/> for software engineering</h4>
                            <Link className="btn btn-outline-primary mt-4 tombol" to="/sekolah">
                                Go
                            </Link>
                        </div>
                    </div>
